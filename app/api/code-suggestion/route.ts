...
import { resolveAIConfig, callAICompletion } from "@/lib/ai-provider"
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Resolve AI configuration from headers or request body
    ...
    // Call AI service with resolved provider and credentials
    const suggestion = await generateSuggestion(prompt, config)
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a precise code autocomplete engine. Complete the code starting immediately at the cursor. Output ONLY the code to insert. Do not wrap in markdown code blocks unless the context demands it. Do not include introductory or explanatory remarks.",
        },

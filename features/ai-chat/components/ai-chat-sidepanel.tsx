...
import { AISettingsModal } from "@/features/playground/components/dialogs/ai-settings-modal";
import { getAIHeaders } from "@/features/playground/hooks/useAISettings";
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorMessage =
          errorData.error ||
          "Sorry, I encountered an error while processing your request. Please check your AI Settings and try again.";
        setMessages((prev) => [
          ...prev,
          {
            role: "assistant",
            ...
            <div className="flex items-center justify-between p-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="h-8 gap-1 text-xs bg-zinc-900/80 border-zinc-800 hover:bg-zinc-800 text-zinc-300 hover:text-zinc-100"
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onClick={() => setShowSettings(true)}
                      className="cursor-pointer text-indigo-300 font-medium"
                    >

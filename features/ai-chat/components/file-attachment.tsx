          ...
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 border rounded-full flex flex-col justify-center items-center">
                <Image src={"/logo.png"} alt="VibeForge Logo" width={28} height={28} className="object-contain" />
              </div>
              <div>
          ...
          <div className="p-6 space-y-6">
            {messages.length === 0 && !isLoading && (
              <div className="text-center text-zinc-500 py-16">
                <div className="relative w-16 h-16 border border-zinc-800 rounded-full flex flex-col justify-center items-center mx-auto mb-4 bg-zinc-900 overflow-hidden">
                  <Image src={"/logo.png"} alt="VibeForge Logo" width={36} height={36} className="object-contain" />
                </div>

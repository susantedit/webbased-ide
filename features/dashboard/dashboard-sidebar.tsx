    ...
    <Sidebar variant="inset" collapsible="icon" className="border-1 border-r">
      <SidebarHeader>
        <div className="flex items-center gap-2.5 px-3 py-2">
          <Image src="/logo.png" alt="VibeForge Logo" height={32} width={32} className="object-contain" />
          <span className="font-bold text-base tracking-tight text-zinc-100 group-data-[collapsible=icon]:hidden">
            VibeForge
          </span>
        </div>
      </SidebarHeader>
